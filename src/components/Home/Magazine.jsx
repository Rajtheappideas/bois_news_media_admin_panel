...
const Magazine = () => {
  ...
  return (
    <>
      {showAddnewMagazine && !showEditMagazine && (
            ...
            <table className="border-none outline-none w-full overflow-scroll">
              ...
              <tbody className="w-full">
                <tr className="border-b border-gray-200 w-full text-left">
                  ...
                  <td className="text-left p-4 whitespace-nowrap">BOISmag</td>
                  <td className="text-left p-4 whitespace-nowrap">€ 95.00</td>
                  <td className="text-left p-4 whitespace-nowrap">40</td>
                  ...
                  <td className="flex items-center justify-start p-4">
                    <button
                      onClick={() => setshowEditMagazine(true)}
                      type="button"
