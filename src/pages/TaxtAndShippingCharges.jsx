          ...
          {role === "admin" && (
            <>
              {isEditing ? (
                ...
                >
                  {updateLoading ? t("Saving").concat("...") : t("Save")}
                </button>
              ) : (
                <button
                  disabled={updateLoading || loading}
        ...
        <div className="w-full grid md:grid-cols-3 place-items-start items-center md:gap-5 gap-2">
          ...
          <div className="w-full space-y-2">
            ...
            {isEditing ? (
              ...
              <p className="font-semibold">{tax?.MetropolitanFrance} %</p>
            )}
          </div>
          {/* EEC_Switzerland_Overseas */}
          <div className="w-full space-y-2">
            <label htmlFor="EEC_Switzerland_Overseas" className="Label">
            ...
            {isEditing ? (
              ...
              <p className="font-semibold">{tax?.EEC_Switzerland_Overseas} %</p>
            )}
          </div>
          {/* RestOfTheWorld */}
          <div className="w-full space-y-2">
